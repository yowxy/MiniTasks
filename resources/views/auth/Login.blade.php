...
<body>
  ...
  <div class="bg-white p-8 rounded-xl shadow-md w-full max-w-md">
    ...
    <form action="#" method="POST" class="space-y-5">
      ...
      <button type="submit" class="w-full bg-indigo-600 text-white py-2 rounded-lg font-medium hover:bg-indigo-700 transition">Masuk</button>
    </form>
    <p class="text-sm text-center text-gray-600 mt-6">Belum punya akun? <a href="{{ route('Register') }}" class="text-indigo-600 hover:underline">Daftar sekarang</a></p>
  </div>
</section>
